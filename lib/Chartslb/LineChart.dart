...
List<Series<AccPt, int>> getAccRawSeries(
  ...
  Series<AccPt, int> seriesAccx = Series(
      id: 'accx',
      data: [],
      domainFn: (AccPt accpt, _) => accpt.index,
      measureFn: (AccPt accpt, _) => accpt.value);

  Series<AccPt, int> seriesAccy = Series(
      id: 'accy',
      data: [],
      domainFn: (AccPt accpt, _) => accpt.index,
      measureFn: (AccPt accpt, _) => accpt.value);

  Series<AccPt, int> seriesAccz = Series(
      id: 'accz',
      data: [],
      domainFn: (AccPt accpt, _) => accpt.index,
      measureFn: (AccPt accpt, _) => accpt.value);
...
List<Series<FFTPt, double>> GetFFTSeries(List<double> fftx, List<double> ffty,
  ...
  Series<FFTPt, double> seriesAccx = Series(
      id: 'FFT-X',
      data: [],
      domainFn: (FFTPt accpt, _) => accpt.freqPt,
      measureFn: (FFTPt accpt, _) => accpt.mag);

  Series<FFTPt, double> seriesAccy = Series(
      id: 'FFT-Y',
      data: [],
      domainFn: (FFTPt accpt, _) => accpt.freqPt,
      measureFn: (FFTPt accpt, _) => accpt.mag);

  Series<FFTPt, double> seriesAccz = Series(
      id: 'FFT-Z',
      data: [],
      domainFn: (FFTPt accpt, _) => accpt.freqPt,
      measureFn: (FFTPt accpt, _) => accpt.mag);
