...
charts.ChartBehavior<DateTime> iSORangeAnnotationForDateTimeAxis(
    [int _class = 1]) {
...
charts.ChartBehavior<DateTime> getRanAnnoByClassNum(classNUmber) {
  ...
  double staisfactoryStart =
      classSepcMap[classNUmber]!.staisfactory.start;
  double staisfactoryEnd =
      classSepcMap[classNUmber]!.staisfactory.end;
  double unstaisfactoryStart =
      classSepcMap[classNUmber]!.unstaisfactory.start;
  double unstaisfactoryEnd =
      classSepcMap[classNUmber]!.unstaisfactory.end;
  double unacceptableStart =
      classSepcMap[classNUmber]!.unacceptable.start;
  double unacceptableEnd =
      classSepcMap[classNUmber]!.unacceptable.end;

  return charts.RangeAnnotation([
    charts.RangeAnnotationSegment(
        goodStart, goodEnd, charts.RangeAnnotationAxisType.measure,
        endLabel: 'Good-$goodEnd',
        color: charts.MaterialPalette.green.shadeDefault),
    charts.RangeAnnotationSegment(staisfactoryStart, staisfactoryEnd,
        charts.RangeAnnotationAxisType.measure,
        endLabel: 'Staisfactory-$staisfactoryEnd',
        color: charts.MaterialPalette.yellow.shadeDefault),
    charts.RangeAnnotationSegment(unstaisfactoryStart,
        unstaisfactoryEnd, charts.RangeAnnotationAxisType.measure,
        endLabel: 'Unstaisfactory-$unstaisfactoryEnd',
        color: charts.MaterialPalette.deepOrange.shadeDefault),
    charts.RangeAnnotationSegment(unacceptableStart, unacceptableEnd,
        charts.RangeAnnotationAxisType.measure,
        endLabel: 'Unacceptable-$unacceptableEnd',
...
class ChartISOProperty {
  final bool showIso;
  final int isoType;
  const ChartISOProperty(
      {required this.showIso, required this.isoType});
}
